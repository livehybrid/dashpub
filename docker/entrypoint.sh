...
# Set CLI environment variables (required for dashpub init to work)
export DASHPUB_FOLDERNAME=$DASHPUB_FOLDERNAME
export DASHPUB_PROJECTNAME=$DASHPUB_PROJECTNAME
export DASHPUB_APP=$DASHPUB_APP
export DASHPUB_DASHBOARDS=$DASHPUB_DASHBOARDS
export DASHPUB_VERCEL=$DASHPUB_VERCEL
export DASHPUB_CUSTOM_VIZ_PATH=$DASHPUB_CUSTOM_VIZ_PATH
export DASHPUB_CUSTOM_DEPS=$DASHPUB_CUSTOM_DEPS
export DASHPUB_CUSTOM_HOME_PATH=$DASHPUB_CUSTOM_HOME_PATH
export DASHPUB_CONFIGFILE=$DASHPUB_CONFIGFILE
export DASHPUB_BUILD_ID=$DASHPUB_BUILD_ID
